        ...
        <div style={{ marginLeft: '80px', marginRight: '80px' }}>
          <main className='p-4'>
            ...
            <ul className='list-disc pl-5'>
              <li>
                En un bowl mezcla el aceite de oliva con el ajo en polvo, la sal
                y la pimienta. Barniza el sartén parrilla con la mezcla, coloca
                el pollo y baña con la misma mezcla hasta cubrir. Cocina por 15
                minutos, procura que cada lado quede bien cocido. Retira del
                fuego y corta en láminas de 1 centímetro de grosor. Reserva.
              </li>
              <li>
                Para el aderezo, en un bowl ensaladero mezcla las anchoas con el
                ajo, la mostaza Dijon y la salsa inglesa, apóyate de una cuchara
                para incorporar poco a poco los ingredientes. Rompe la cáscara
                de la pieza de Huevo San Juan y separa la clara de la yema.
                Vierte sólo la yema a la preparación e incorpora. Añade el jugo
                del limón y vierte poco a poco el aceite de oliva sin dejar de
                mover. Agrega el queso parmesano y las hojas de lechuga, baña
                por completo.
              </li>
              <li>
                Sirve las hojas de lechuga en un plato, añade el pollo cocido,
                los crutones de pan y decora con láminas de parmesano.
                ¡Disfruta!
              </li>
            </ul>
          </main>
