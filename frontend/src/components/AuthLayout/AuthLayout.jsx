          ...
          <div className='w-1/2 mx-auto -mt-20 z-10'>
            ...
            <footer className="footer items-center p-4 bg-neutral text-neutral-content mt-10">
              ...
              <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                ...
                <h3 className='font-bold'>Meal Map</h3>
              </aside> 
              <nav className="grid-flow-col gap-4 place-self-center justify-self-center">
              ...
              <nav className="pr-5 grid-flow-col gap-6 md:place-self-center md:justify-self-end">
                <a className='font-semibold'>Blog</a>
                <a className='font-semibold'>Recetas</a>
                <a className='font-semibold'>Tips</a>
              </nav>
            </footer>
        </div>
      </Layout>
